...
function rotate(jobject) {
    let sigil = $(jobject);
    let rotation = sigil.data("rotation");
...
const BlockImages = {
    I: { width: 4, height: 1, vtr_x: '', vtr_y: '' },
    O: { width: 2, height: 2, vtr_x: '', vtr_y: '' },
        ...
        drop: (event, ui) => {
            ...
            sigil.css({
                ...
                .draggable({
                    ...
                    start: (event, ui) => {
                        ui.helper.css({ "z-index": 1001 });
                        let rotation = ui.helper.data("rotation");
                        if (!rotation) rotation = 0;
